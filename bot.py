...
# ==========================
TOKEN = "8256799490:AAHE5IxNEh96C_ZipPeLZt2sqp-HYnOFZC4"   # <- Поставь сюда реальный токен
ADMIN_ID = 279799183                     # твой admin id (оставил тот что предоставил)
...
HELP_CONTACT_TEXT = "Если нужна помощь — напиши админу: @your_admin_username или отправь сообщение сюда, мы ответим."
